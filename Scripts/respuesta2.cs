        ...
        if(entrada == aux2.ToString()){
            ...
            if(lvl == niveles){
                if (scene.name == "nivel5")
                {
                    ...
                    if (PlayerPrefs.GetInt("nivel5", 0) != 1)
                    {
                        addestrellas();
                    }
                    PlayerPrefs.SetInt("nivel5", 1);
                }
                if (scene.name == "nivel6")
                {
                    SceneManager.LoadScene("Selectlevel");
                    if (PlayerPrefs.GetInt("nivel6", 0) != 1)
                    {
                        addestrellas();
                    }
                    PlayerPrefs.SetInt("nivel6", 1);
                }
                if (scene.name == "nivel7")
                {
                    SceneManager.LoadScene("Selectlevel");
                    if (PlayerPrefs.GetInt("nivel7", 0) != 1)
                    {
                        addestrellas();
                    }
                    PlayerPrefs.SetInt("nivel7", 1);
                }
                if (scene.name == "nivel8")
                {
                    SceneManager.LoadScene("Selectlevel");
                    if (PlayerPrefs.GetInt("nivel8", 0) != 1)
                    {
                        addestrellas();
                    }
